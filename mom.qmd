...
\begin{align*}
  ...
  \frac{1}{\theta} & = \frac{1}{n} \sum_{i = 1}^n y_i \\
  \theta & = \frac{1}{\bar{x}}
\end{align*}
```

And so the MOM estimator for $\theta$ is 1 divided by the sample mean. Note that this is an example where the MOM estimator and MLE are not the same (you derived the MLE on your first problem set)!
